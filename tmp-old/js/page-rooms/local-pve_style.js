...
async function left_panel_pve(obj)
{
	return true;
}

async function small_card_pve(obj)
{
	const main = obj.main_div;
...
async function chat_room_pve(obj)
{
	const main = obj.main_div;
	main.classList.add("d-flex");
	...
	title.textContent = "ROOM#LOCAL-PVE";
...
async function players_list_pve(obj)
{
	const main = obj.main_div;
